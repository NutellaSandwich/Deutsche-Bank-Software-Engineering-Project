...
import datetime
import requests
# set bypass_ahp to true in cwk.py for the tests to run correctly
...
def test_tech_intersection(logged_in_user):
    # ticking technology checkbox
    response = logged_in_user.post("/project_technology/1", data ={
            "1": True,
            "3": True
        })
    ...
    # adding technology to user
    uresponse1 = logged_in_user.post("/user_technology", data= {"user_id": 1, "technology_id": 1, "1": "2"})
